...
#define		WDVAL	  0x40//0x40	//0x26	//0.5V		   稳定
...
//#define		WDSSVAL	  0x55//0x2A	//0x1E	//0.4V		   持续闪烁
//#define		NOSSVAL	  0x50//0x20	//0X17	//0.3V		   有挡就无
//#define		NOVAL	  0x4A//0x1A	//0X11	//0.23V		   无信号										  //0X11
...
//	INT8U	occnt;
	...
	INT8U  idata  sampDat[SAMPCNTMAX] ,difDat[SAMPCNTMAX],DsampDat[SAMPCNTMAX],difDat1[SAMPCNTMAX];
...
void ADC_Init (void)
{
	...
	ADC0CF = 0x09;//转换频率为6M（max），1倍增益  ,1/2系统时钟
